...
import com.example.catnote.Alarm.AlarmReceiver;
import com.example.catnote.Alarm.EditAlarmActivity;
import com.example.catnote.Alarm.Plan;
import com.example.catnote.Alarm.PlanAdapter;
import com.example.catnote.Alarm.PlanDatabase;
...
public class MainActivity extends BaseActivity implements OnItemClickListener, OnItemLongClickListener {
    ...
    public void refreshListView() {
        ...
        com.example.catnote.Alarm.CRUD op1 = new com.example.catnote.Alarm.CRUD(context);
        op1.open();
        if(planList.size() > 0) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (returnMode == 1) {  //update current note
            ...
            plan.setId(note_Id);
            com.example.catnote.Alarm.CRUD op = new com.example.catnote.Alarm.CRUD(context);
            op.open();
            op.updatePlan(plan);
            op.close();
